...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		validarTiempo( tiempo.getDia(), tiempo.getMes(), tiempo.getAño(),
				tiempo.getHora(), tiempo.getMinuto(), tiempo.getSegundo()
		);
		imprimirTiempo( tiempo.getDia(), tiempo.getMes(), tiempo.getAño(),
				tiempo.getHora(), tiempo.getMinuto(), tiempo.getSegundo()
		);
		
		TiempoRecord tiempo_record = new TiempoRecord(23,05,2023, 15,25,17);
		validarTiempo( tiempo_record.dia(), tiempo_record.mes(), tiempo_record.año(),
				tiempo_record.hora(), tiempo_record.minuto(), tiempo_record.segundo()
		);
		imprimirTiempo( tiempo_record.dia(), tiempo_record.mes(), tiempo_record.año(),
				tiempo_record.hora(), tiempo_record.minuto(), tiempo_record.segundo()
		);
	}
	...
	public static void validarTiempo(int dia, int mes, int año, int hora, int minuto, int segundo) throws Exception
	{
		try {
			...
			throw new Exception("Tiempo no válido "+fechaCorta(dia,mes,año,hora,minuto,segundo)+": "+e.getMessage());
		}
	}
